				...
				<Row className="pricing d-md-flex align-items-center justify-content-around pb-5">
					<Col className="tickit-package">
						...
						<p>
							...
							minimum 50 persons. School Picnic Package is not available
							on Friday and Saturday. All Prices are inclusive of VAT.
						</p>
						<p>
							<i className="fas fa-check"></i> Best Waterpark in the
							world
						</p>
						<p>
							<i className="fas fa-check"></i> Best Packages For Your
							Family
						</p>
						<p>
							<i className="fas fa-check"></i> Enjoy Various Kinds of
							Water Park
						</p>
						<p>
